        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-lg">Manage discount vouchers and promotional codes</p>
            </div>
            <Button
              onClick={() => {
                resetForm();
              ...
              className="px-6 py-2 bg-[var(--color-gold)] text-[var(--color-navy)] rounded-lg font-medium hover:opacity-90"
            >
              ...
              <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 flex gap-4">
                  <Button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-2 bg-[var(--color-gold)] text-[var(--color-navy)] rounded-lg font-medium hover:opacity-90 disabled:opacity-50"
                  >
                  ...
                  <Button
                    ...
                    className="px-6 py-2 bg-gray-600 text-white rounded-lg font-medium hover:opacity-90"
                  >
                    Cancel
                  </Button>
                </div>
