    ...
    >
      <div className="container mx-auto px-4 sm:px-6 flex justify-between items-center py-4 sm:py-4 min-h-[56px] sm:min-h-[72px]">
        ...
        <div className="desktop-menu flex-row gap-10 items-center justify-end">
          ...
          <Link href="/merchandise" className="navbar-link transition-colors duration-200 cursor-pointer text-[var(--color-lightgrey)] hover:text-[var(--color-gold)]">Merchandise</Link>
